...
<FileTree>
  <FileTree.Folder name="Library (Hard Dependency)" defaultOpen>
  ...
  <FileTree.Folder name="Compatible Framework's" defaultOpen>
  ...
  <FileTree.Folder name="Compatible Inventories" defaultOpen>
  ...
  <FileTree.Folder name="Compatible Ambulance Jobs" defaultOpen>
...
<Callout type="warning" emoji="⚠️">
  In case your inventory or ambulance job isn't in list, check [this](../deathmatch/integration)
</Callout>
