...
<FileTree>
  <FileTree.Folder name="Hard Dependency" defaultOpen>
  ...
  <FileTree.Folder name="Compatible Framework's" defaultOpen>
    ...
    <FileTree.File name={<a href="https://github.com/qbcore-framework/qb-core" target="_blank" rel="noopener noreferrer" style={{ textDecoration: 'none' }}>QBCore</a>} />
